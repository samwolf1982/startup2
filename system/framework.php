...
{
    $cfg->set_model_directory(DIR_APPLICATION.'model/extension/active');
    $cfg->set_connections(array('development' => 'mysql://'.DB_USERNAME.':'.DB_PASSWORD.'@'.DB_HOSTNAME.'/'.DB_DATABASE));
});
