...
if ($this->config->get('occm_status')) $this->document->addScript($this->url->link('extension/module/occm/js','',true));
        ...
        $this->document->addStyle('/catalog/view/javascript/libs/xzoom-master/xZoom-master/dist/xzoom.css');

        $this->document->addStyle('/catalog/view/theme/furniturepro/stylesheet/css/product.css');
        $this->document->addStyle('/catalog/view/javascript/libs//xzoom-master/xZoom-master/example/fancybox/source/jquery.fancybox.css');
        $this->document->addScript('/catalog/view/javascript/libs/xzoom-master/xZoom-master/dist/xzoom.min.js');
        $this->document->addScript('/catalog/view/javascript/libs/xzoom-master/xZoom-master/example/hammer.js/1.0.5/jquery.hammer.min.js');
        $this->document->addScript('/catalog/view/javascript/libs/xzoom-master/xZoom-master/example/fancybox/source/jquery.fancybox.js');




        $this->document->addScript('/catalog/view/javascript/furnitureprojs/js/product.js');
		...
		if ($product_info) {
			...
			if(isset($this->request->post['quickviewpost'])) {
			...
			$data['required_text_option'] = $this->language->get('text_required');
			...
			if(isset($this->request->post['quickviewpost'])) {
				$data['quickviewmodule'] = $this->load->view('extension/module/quickviewpro', $data);
			} else {
