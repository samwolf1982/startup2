...
class ControllerCheckoutCart extends Controller {
	public function index() {
        ...
        $this->document->addStyle('/catalog/view/theme/furniturepro/stylesheet/css/cart.css');
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			} elseif ($this->config->get('min_order_total_status')) {  // start min order total
