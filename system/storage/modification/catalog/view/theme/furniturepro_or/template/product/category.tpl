      ...
      <div class="col-sm-6 wrp_filter_area">
        <div class="row">
          ...
          <div class="col-xs-12  col-sm-12 col-md-6 filter_area">
              <p>Цена</p>
              <?php if(!empty($attr_item_list_price))  { ?>
              <select name="" onchange="location = this.value;">
                  <option value="<?=$attr_item_list_price_default_url;?>" class="">Выбрать</option>
                  <?php foreach ($attr_item_list_price as $attr_item) { ?>
                  <option value="<?php echo $attr_item['href']; ?>"   <?= $attr_item['current']? 'selected="selected"':'' ?>  ><?php echo $attr_item['text']; ?></option>
                  <?php } ?>
              </select>
              <?php  } ?>
          </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 filter_area ">
                <p class="">Стиль</p>
                <?php if(!empty($attr_item_list))  { ?>
                <select name="" onchange="location = this.value;">
                    <option value="<?=$attr_item_list_default_url;?>" class="">Выбрать</option>
                    <?php foreach ($attr_item_list as $attr_item) { ?>
                    <option value="<?php echo $attr_item['href']; ?>"   <?= $attr_item['current']? 'selected="selected"':'' ?>  ><?php echo $attr_item['text']; ?></option>
                    <?php } ?>
                </select>
                <?php  } ?>
      ...
      <div class="col-sm-6 wrp_filter_area filter_area_right ">
       <div class="row">
           ...
           <div class="col-xs-12  col-sm-12 col-md-6 filter_area ">
               ...
               <p class="">Цвет</p>
               <?php if(!empty($attr_item_list_color))  { ?>
               <select name="" onchange="location = this.value;">
                   <option value="<?=$attr_item_list_color_default_url;?>" class="">Выбрать</option>
                   <?php foreach ($attr_item_list_color as $attr_item) { ?>
                   <option value="<?php echo $attr_item['href']; ?>"   <?= $attr_item['current']? 'selected="selected"':'' ?>  ><?php echo $attr_item['text']; ?></option>
                   <?php } ?>
               </select>
               <?php  } ?>
