...
class ControllerCheckoutOnepagecheckout extends Controller
{
    ...
    public function index()
    {
        ...
        $this->document->addStyle('/catalog/view/theme/furniturepro/stylesheet/css/checkout_onepage.css');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            if ($this->validate_form()) {
                ...
                if( !empty( $this->customer->getId())){
                    $order_data['customer_id'] = (int)$this->customer->getId();
                }
                ...
                if($this->session->data['payment_method']['code']=='cod' || $this->session->data['payment_method']['code']=='cod2')
                $json['cod'] = 1;
...
//
            ...
            //die(var_dump(json_encode($json)));
//            die(var_dump( $json['cod']));
