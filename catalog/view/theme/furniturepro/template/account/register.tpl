        ...
        <div class="col-sm-12 col-md-5">
          <div class="">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
              <input type="hidden" name="login_form" value="10" hidden>
              <div class="form-group">
                <label class="control-label hidden" hidden for="input-email"><?php echo $entry_email; ?></label>
                <input type="text" name="email_login" value="<?php echo $email_login; ?>" placeholder="<?php echo $entry_email; ?>" id="input-email_login" class="form-control" />
              </div>
              <div class="form-group">
                <label class="control-label hidden" hidden for="input-password"><?php echo $entry_password; ?></label>
                <input type="password" name="password" value="<?php echo $password; ?>" placeholder="<?php echo $entry_password; ?>" id="input-password_login" class="form-control" />
                <a href="<?php echo $forgotten; ?>"><?php echo $text_forgotten; ?></a></div>
              <div class="text-center">
                <input type="submit" value="<?php echo $button_login; ?>" class="btn btn-primary btn-lg sale" />
              </div>
