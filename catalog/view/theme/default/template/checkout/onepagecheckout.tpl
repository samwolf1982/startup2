                                    ...
                                    <?php $class = 'col-sm-12'; ?>
                                        ...
                                        <div id="content">
                                            ...
                                            <div class="time_line">
                                                ...
                                                <img class="img-responsive hidden-xs hidden-sm"  src="/image/verstka/heap/timeline1.png" alt="timeline">
                                            </div>
                                        ...
                                        <input type="text" id="telephone-ch" name="telephone"
                                                                     ...
                                                                     <h2>Ваш заказ</h2>
                                                                        ...
                                                                        <?php foreach ($products as $product) { ?>
                                                                            <tr class="ligthgray">
                                                                                        <td class="name">
<div class="">
                                                                                            <img src="<?=$product['img']?>" class="img-responsive" alt="<?php echo $product['name'] ?>">
</div>
                                                                                            <div class="info_cart">
                                                                                                <h3>
                                                                                <a href="/index.php?route=product/product&product_id=<?php echo $product['product_id'] ?>"><?php echo $product['name'] ?>
                                                                                                </h3>
                                                                                </a>
                                                                                <div class="p-model">
                                                                                        Артикул:  <?php echo $product['model'] ?>                                </div>
                                                                                ...
                                                                                <?php foreach ($product['option'] as $option) { ?>
                                                                                    -
                                                                                        ...
                                                                                        <?php endif; ?>
                                                                                                ...
                                                                                                <div class="wrp_text_flex">
                                                                                         <span class="price_name">Цена: </span>       <span class="price"><?php echo $product['price'] ?>   </span>
                                                                                                </div>


                                                                                                <div class="wrp_text_flex">
                                                                                           <span class="quantity_cart">Количество:</span>     <span class="quantity"><?php echo $product['quantity'] ?>  шт.  </span>
                                                                                                </div>
                                                                                                <div class="wrp_text_flex">
                                                                                            <span class="totalprod">Итого: </span>    <span class="price"> <?php echo $product['total'] ?> </span>
                                                                                            </div>
                                                                                            </div>
            ...
            <?php } ?>
                                                                        ...
                                                                        <div class="payment">
                                                                            <a href='index.php?route=checkout/cart'>
                                                                                <div id="button-modify" class="btn btn-primary btn-lg">
                                                                                    <?=$text_cart?>
                                                                                </div>
                                                                            </a>


                                                                        <div id="ajax-button-confirm" class=" btn btn-lg sale">
                                                                        <?=$text_confirm?>
                                                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form  method="post" enctype="multipart/form-data">
                        ...
                        <div class="btn btn-primary submit-login-form sale pull-right" ><?php echo $button_login; ?></div>
                        <div>
