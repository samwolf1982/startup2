...
//            }
            ...
            $colect_cats_arr_lv1 = explode(',', trim($item[1]));

            foreach ($colect_cats_arr_lv1 as $parent_cat_l1) {


            foreach ($c_list as $parent_cat) {
//                $cur_cat_name = htmlspecialchars_decode(trim(($item[1])));
                $cur_cat_name = htmlspecialchars_decode(trim(($parent_cat_l1)));
...
//            $t_prod['des']= empty( $item[6])?$item[13]:$item[6];
            $t_prod['des']= empty( $item[13])?$item[6]:$item[13];    // gjg
...
//            $t_prod['meta_key']= $item[46];
            $t_prod['tags']= $item[6].','.$item[7].','.$item[9];
        ...
        foreach ($this->prod_arr_list as $kj=> $mr) {
           // if($kj==0||$kj==1){continue;}
            $tmp=[
              ...
              //  'price' => 25.66,
                'points' => '',
//                'date_added' =>  date('Y-m-d H:i:s'), '2009-02-03 16:59:00',
//                'date_modified' =>date('Y-m-d H:i:s') '2009-02-03 16:59:00',
//                'date_available' =>date('Y-m-d') '2009-02-03',
